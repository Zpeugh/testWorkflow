...
class TestWorkFlow extends Specification{
	...
	def JUflow = new SampleWorkFlow('JU--UPDATED.json')
		...
		def 'SPIDA: Test-Flow: Generated all forms'() {
		...
		def 'SPIDA: Test-Flow: Captured all actions'() {
		...
		def 'SPIDA: Test-Flow: Generated all actions'() {
		...
		def 'DLC: DLC Overhead: Capture all forms'() {
		...
		def 'DLC: DLC Overhead: Generated all forms'() {
		...
		def 'DLC: DLC Overhead: Captured all actions'() {
		...
		def 'DLC: DLC Overhead: Generated all actions'() {
		...
		def 'ACME~Power~Co.: Joint Use WorkFlow: Captured all forms'() {
		...
		def 'ACME~Power~Co.: Joint Use WorkFlow: Generated all forms'() {
		...
		def 'ACME~Power~Co.: Joint Use WorkFlow: Captured all actions'() {
		...
		def 'ACME~Power~Co.: Joint Use WorkFlow: Generated all actions'() {
